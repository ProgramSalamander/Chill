      ...
      <div className="max-w-4xl w-full flex flex-col items-center text-center space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-2xl">
          <button 
            ...
            className="group relative p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-vibe-accent/50 hover:bg-vibe-accent/5 transition-all duration-300 text-left overflow-hidden"
          >
            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
               <IconPlus size={120} />
            </div>
            <div className="relative z-10 flex flex-col gap-4">
              <div className="w-12 h-12 rounded-2xl bg-vibe-accent/20 flex items-center justify-center text-vibe-glow group-hover:scale-110 transition-transform">
                 <IconPlus size={24} />
              </div>
              <div>
                <h3 className="text-xl font-bold text-white mb-1">New Project</h3>
                <p className="text-sm text-slate-500">Start from scratch in a clean workspace.</p>
              </div>
            </div>
          </button>
          ...
          <button 
            ...
            className="group relative p-8 rounded-3xl bg-white/5 border border-white/10 hover:border-indigo-400/50 hover:bg-indigo-400/5 transition-all duration-300 text-left overflow-hidden"
          >
            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
            ...
            <div className="relative z-10 flex flex-col gap-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-white mb-1">Clone Repository</h3>
                <p className="text-sm text-slate-500">Import an existing project from Git.</p>
              </div>
            </div>
          </button>
        </div>
          ...
          <div className="w-full max-w-2xl space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
               {recentProjects.map(proj => (
                 <div 
                  key={proj.id}
                  className="group relative flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5 hover:border-white/10 hover:bg-white/[0.07] transition-all cursor-pointer"
                  onClick={() => handleLoadProject(proj)}
                 >
                    <div className="flex items-center gap-4 min-w-0">
                       <div className="w-10 h-10 rounded-xl bg-slate-800/50 flex items-center justify-center text-slate-500 group-hover:text-vibe-glow transition-colors">
                          <IconFolder size={20} />
                       </div>
                       <div className="text-left truncate">
                          <p className="text-sm font-bold text-slate-200 truncate group-hover:text-white transition-colors">{proj.name}</p>
                    ...
                    <Tooltip content="Delete Project" position="top">
                      <button 
                        ...
                        className="p-2 rounded-xl text-slate-600 hover:text-red-400 hover:bg-red-500/10 opacity-0 group-hover:opacity-100 transition-all"
                      >
                        <IconTrash size={16} />
                      </button>
                    </Tooltip>
        ...
        <div className="pt-8 grid grid-cols-1 sm:grid-cols-3 gap-8 w-full max-w-3xl opacity-50 grayscale hover:grayscale-0 transition-all duration-700">
           <div className="flex flex-col items-center gap-3">
              ...
              <p className="text-xs font-medium text-slate-400">AI Contextual Search</p>
           </div>
           <div className="flex flex-col items-center gap-3">
              <IconGitBranch size={20} className="text-indigo-400" />
              <p className="text-xs font-medium text-slate-400">Integrated Git Support</p>
           </div>
           <div className="flex flex-col items-center gap-3">
              <IconFolder size={20} className="text-purple-400" />
              <p className="text-xs font-medium text-slate-400">Project Management</p>
           </div>
        </div>
      </div>
    </div>
